...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/BiAyEnGiii/rosemoc/main/library.lua"))()
getgenv().api = loadstring(game:HttpGet("https://raw.githubusercontent.com/BiAyEnGiii/rosemoc/main/apirbxsystem.lua"))()
local bssapi = loadstring(game:HttpGet("https://raw.githubusercontent.com/BiAyEnGiii/rosemoc/main/api.lua"))()
local save = loadstring(game:HttpGet("https://raw.githubusercontent.com/BiAyEnGiii/rosemoc/main/save.lua"))()
...
local savess = premiumtab:CreateSection("Save Setting")
savess:CreateButton("Save", function()
    savel()
end)
